...
public class M_account {
    ...
    public static String[] history = new String[HISTORY_MAX_LENGTH];
    public static int historyIdx = -1;


    public static void printCreateAcountMenu() {
        ...
        System.out.println("계좌가 생성되었습니다. [이름]" + userAccount + " ,[계좌번호]" + userAccount);
    }
    ...
    public static void manageHistory(String historyMessage) {
        historyIdx++;
